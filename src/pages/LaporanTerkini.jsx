    ...
    <div className="flex flex-col gap-5 justify-center  align-middle mt-10 px-10 max-[1300px]:mt-0">
          ...
          <div className="h-[44px]  flex flex-row gap-2 w-full align-middle ">
            ...
            <label className="relative block h-full ">   
              ...
              <input className="w-[449px] h-full  placeholder:text-[#0057FF] block bg-transparent  border border-[#0057FF] rounded-md pt-1.5 pl-11 pr-0 shadow-sm text-[12px] focus:ring-1 sm:text-sm" placeholder="Search Laporan" type="text" name="search"/>
            </label>
             </div>
