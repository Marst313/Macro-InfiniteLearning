                  ...
                  return (
                    <React.Fragment>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink end to="/profiles" className={({ isActive }) => 'flex items-center transition duration-150 truncate ' + (isActive ? 'text-whiteSecondary' : 'text-slate-400 hover:text-whiteSecondary')}>
