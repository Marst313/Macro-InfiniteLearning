...
const HeaderLs = ({ setSearch, search }) => {
  return (
    <div className="mt-10 flex justify-between p-1">
      ...
      <div className="flex gap-5">
        <form className="relative">
          ...
          <input type="text" placeholder="Search Report" className="px-5 py-2 rounded-lg w-96 border-bg-primary pl-7 placeholder:opacity-50 placeholder:text-bg-primary" value={search} onChange={(e) => setSearch(e.target.value)} />
        </form>
