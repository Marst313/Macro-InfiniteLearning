...
import DataSearch from './DataSearchPages';
...
function ModalSearch({ id, searchId, modalOpen, setModalOpen }) {
  ...
  return (
    <>
      ...
      >
        <div ref={modalContent} className="bg-white dark:bg-slate-800 border border-transparent dark:border-slate-700 overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg">
          {/* Search form */}
          <form className="border-b border-slate-200 dark:border-slate-700">
            <div className="relative">
              ...
              <button className="absolute inset-0 right-auto group" type="submit" aria-label="Search">
                <svg className="w-4 h-4 shrink-0 fill-current text-slate-400 dark:text-slate-500 group-hover:text-slate-500 dark:group-hover:text-slate-400 ml-4 mr-2" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="py-4 px-2">
            ...
            <div className="mb-3 last:mb-0">
              ...
              <ul className="text-sm">
                <li>
                  <Link className="flex items-center p-2 text-slate-800 dark:text-slate-100 hover:text-white hover:bg-indigo-500 rounded group" to="#0" onClick={() => setModalOpen(!modalOpen)}>
            ...
            <div className="mb-3 last:mb-0">
              ...
              <DataSearch setModalOpen={setModalOpen} modalOpen={modalOpen} />
            </div>
          </div>
        </div>
      </Transition>
